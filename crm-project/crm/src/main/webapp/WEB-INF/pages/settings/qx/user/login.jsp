        ...
        $(function () {
            ...
            $("#logBtn").click(function () {
                ...
                $.ajax({
                    ...
                    before: function () {
                        //ajax向后台发请求之前，会自动执行本函数
                        //该函数的返回值能够决定ajax是否真正向后台发送请求
                        //如果该函数返回true，则ajax会真正向后台发请求，否则，如果该函数返回false
                        //则ajax不会向后台发请求
                        //这个地方可以显示  正在验证...
                        $("#msg").text("正在验证...");
                        return true;
...
<div id="top" style="height: 50px; background-color: #3C3C3C; width: 100%;">
    <div style="position: absolute; top: 5px; left: 0px; font-size: 30px; font-weight: 400; color: white; font-family: 'times new roman'">
        CRM &nbsp;<span style="font-size: 12px;">&copy;2022&nbsp;pys</span></div>
</div>
    ...
    <div style="position: absolute; top: 0px; right: 60px;">
        ...
        <form action="workbench/index.html" class="form-horizontal" role="form">
            <div class="form-group form-group-lg">
                ...
                <button type="button" id="logBtn" class="btn btn-primary btn-lg btn-block"
