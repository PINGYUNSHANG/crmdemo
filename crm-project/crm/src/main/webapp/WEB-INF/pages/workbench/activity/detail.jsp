                ...
                $.ajax({
                    ...
                    success: function (data) {
                        if (data.code == "1") {
                            ...
                            htmlStr += "<img title=\"${applicationScope.sessionUser.name}\" src=\"image/user-thumbnail.png\" style=\"width: 30px; height:30px;\">";
                            htmlStr += "<div style=\"position: relative; top: -40px; left: 40px;\" >";
                            htmlStr += "<h5>" + data.retData.noteContent + "</h5>";
                            htmlStr += "<font color=\"gray\">市场活动</font> <font color=\"gray\">-</font> <b>${activity.name}</b> <small style=\"color: gray;\"> " + data.retData.createTime + " 由${applicationScope.sessionUser.name}创建</small>";
                ...
                $.ajax({
                    ...
                    success: function (data) {
                        if (data.code == "1") {
                            ...
                            $("#div_" + data.retData.id + " small").text(" " + data.retData.editTime + " 由${applicationScope.sessionUser.name}修改");
                        } else {
                            //提示信息
                            alert(data.message);
                            //模态窗口不关闭
        ...
        <div id="div_${remark.id}" class="remarkDiv" style="height: 60px;">
            ...
            <div style="position: relative; top: -40px; left: 40px;">
                ...
                <div style="position: relative; left: 500px; top: -30px; height: 30px; width: 100px; display: none;">
                    <a class="myHref" href="javascript:void(0);" remarkId="${remark.id}" name="editA"><span
                            class="glyphicon glyphicon-edit"
                            style="font-size: 20px; color: #E6E6E6;"></span></a>
                    &nbsp;&nbsp;&nbsp;&nbsp;
                    <a class="myHref" href="javascript:void(0);" remarkId="${remark.id}" name="deleteA"><span
