				...
				<div class="modal-body">
					<form class="form-horizontal" role="form">
						...
						<div class="form-group" style="position: relative;">
							...
							<div class="col-sm-10" style="width: 300px;">
<%--								用于测试--%>
								<input type="hidden" id="create-customerId" value="0fecb4b181164ce98acb9b536c0555b1">
			...
			<div style="position: relative;top: 20px;">
				<table class="table table-hover" id="tBody">
					...
					<c:forEach items="${contactsList}" var="c">
						<tr class="active">
							<td><input type="checkbox" /></td>
							<td><a style="text-decoration: none; cursor: pointer;" onclick="window.location.href='detail.html';">${c.fullname}</a></td>
							<td>${c.customerId}</td>
							<td>${c.owner}</td>
							<td>${c.source}</td>
							<td>${c.createTime}</td>
